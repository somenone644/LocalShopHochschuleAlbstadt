...
try {
    ...
    const dbFile = './Backend/db/webanw2.sqlite';
    ...
    var serviceRouter = require('./services/produkte.js');
    app.use(TOPLEVELPATH, serviceRouter);

    serviceRouter = require('./services/adresse.js');
    app.use(TOPLEVELPATH, serviceRouter);
    
    serviceRouter = require('./services/dateiuploadmehrere');
    app.use(TOPLEVELPATH, serviceRouter);
    ...
    serviceRouter = require('./services/dataRouter.js');
    app.use(TOPLEVELPATH,serviceRouter);
